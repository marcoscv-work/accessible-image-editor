...
/**
 * Editing a text annotation where it sits, rather than in a dialog away
 * from it. A real input inside a `foreignObject`, dressed to match the
 * text underneath and sized from the same metrics, so what is typed is
 * what will be drawn.
 */
