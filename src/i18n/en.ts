...
export default {
	...
	'draw-guided-bend': 'Line set. Move the middle point with the arrow keys to curve the line, then press Enter to finish.',
	'draw-guided-move-first': 'Move the end away from the start first.',
	'draw-guided-start': 'Drawing a line from the center of the crop area. Move its end with the arrow keys, then press Enter to set the line.',
	'draw-instructions': 'Click or press Enter to add points. Arrow keys move the cursor, Backspace removes the last point, Enter on the last point or a double click finishes, Escape cancels.',
	'draw-point-added': 'Point {0} at {1}, {2}',
	'draw-point-removed': 'Point removed',
	'draw-started': 'Drawing. Click or press Enter to add points; finish on the last point.',
