...
describe('a frame', () => {
	...
	it('measures itself against the crop, not the image', () => {
		...
		// 4% of the shorter side, 1000, is a 40 wide band; a stroke is
		// centred on its path, so it is inset by 20.
	...
	it('reframes itself when the crop moves and shrinks', () => {
		...
		// The same frame, drawn again from a 500 square at (300, 200):
		// 4% of 500 is 20, so the band sits inset by 10 from the new
		// edges. Nothing about the frame was stored in image coordinates.
	...
	it('offsets the frame from the edge when asked', () => {
		...
		// 5% of 1000 is 50, plus half of the 40 wide band.
