...
7. Freehand ink-as-pixels out of scope; drawing ships as a parametric stroke object, with the gesture as a pointer convenience under WCAG's path-dependent-input exemption and a dragless pen route beside it.
...
Out of scope (README): pixel-ink freehand, background removal, EXIF/color management, HEIC.
