...
- **The crop's proportion lock reaches the stage**: with it on, the marquee offers the four corners and no side handles, because stretching one axis is exactly what the lock forbids, and a corner drag keeps the ratio without asking for Shift.
